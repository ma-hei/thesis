## same scenario as before but with sparser training data

n_drugs = 50
n_targets = 70

data = generate_dataset_scenario_3(n_drugs, n_targets)
complete = data[[1]]
train = data[[2]]
...
params = train_crf(train = train, adj = adj_mat, 500, 50)

## get the vector X of the mf predictions on the complete data
X = get_mf_prediction(train, 100)

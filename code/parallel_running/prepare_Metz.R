...
drug_adj_mat = make_adj_mat_thresh(sim_mat = drug_sim, thresh = drug_thresh, TRUE)

n_folds = 5
test_folds = get_folds(dataset_triplets, n_folds)

save(test_folds, dataset_triplets, drug_adj_mat, target_adj_mat, file = "5fold_cv_data_metz.Rda")

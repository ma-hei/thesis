## more columns
## in this scenario, I generate a dataset that has underlying latent factors and
## where the columns are divided into 7 groups, s.th. the values inside each group 
## are similar. The first aspect (latent factors) can be predicted by mf and
## the second aspect can be predicted by a crf.
...
## train a crf on the training data with the given adjacency mat
